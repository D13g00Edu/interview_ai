    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-6 bg-background">
      <div className="max-w-3xl w-full glass-card p-12 space-y-10 animate-in slide-in-from-bottom-10 duration-700 border-border-custom shadow-2xl">
        <div className="space-y-4 text-center">
          <h1 className="text-4xl font-bold text-gradient py-1">Set the Stage</h1>
          <p className="text-foreground/60 font-medium">Configure your session to get the most relevant experience.</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-foreground/40 ml-1">Your Name (Optional)</label>
              <input 
                type="text" 
                value={formData.name}
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-foreground/40 ml-1">Target Position</label>
              <input 
                required
                type="text" 
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-foreground/40 ml-1">Experience Level</label>
              <select 
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-foreground/40 ml-1">Interview Type</label>
              <select 
                value={formData.type}
