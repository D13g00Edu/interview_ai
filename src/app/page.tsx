    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-6 bg-gradient-premium">
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex absolute top-10 px-10">
        <div className="fixed left-0 top-0 flex w-full justify-center border-b border-border/50 bg-background/50 pb-6 pt-8 backdrop-blur-2xl lg:static lg:w-auto lg:rounded-xl lg:border lg:bg-card-custom lg:p-4 shadow-sm">
          <p className="flex items-center gap-2 font-semibold">
            ...
            Entrenador de Entrevistas IA <span className="opacity-40 font-normal">v1.0</span>
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center text-center space-y-8 animate-in fade-in duration-1000 mt-20">
        <h1 className="text-6xl md:text-8xl font-bold tracking-tight text-gradient py-2">
          Domina tu Próxima <br /> Gran Entrevista
        </h1>
        <p className="text-xl md:text-2xl text-foreground/70 max-w-2xl leading-relaxed">
          Impulsado por Google Gemini AI para ofrecer feedback en tiempo real y simulaciones realistas adaptadas a tus metas profesionales.
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-24 max-w-6xl w-full">
        <div className="glass-card p-8 space-y-4 border-border-custom shadow-lg">
          <div className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center text-primary">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
            </svg>
          </div>
          <h3 className="text-xl font-bold">Feedback en Tiempo Real</h3>
          <p className="text-foreground/60 leading-relaxed">Obtén análisis instantáneo de tus respuestas usando LLMs avanzados.</p>
        </div>
        <div className="glass-card p-8 space-y-4 border-border-custom shadow-lg">
          ...
          <h3 className="text-xl font-bold">Preparación Personalizada</h3>
          <p className="text-foreground/60 leading-relaxed">Escenarios generados basándose en tu puesto y nivel objetivo.</p>
        </div>
        <div className="glass-card p-8 space-y-4 border-border-custom shadow-lg">
          ...
          <p className="text-foreground/60 leading-relaxed">Sigue tu progreso e identifica áreas específicas de mejora.</p>
        </div>
      </div>
    </main>
  );
